...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerSpecialist = (Spinner) findViewById(R.id.spinnerSpecialist);
        ...
        editTextSpecialist = (EditText) findViewById(R.id.editTextSpecialist);
        ...
        spinnerFrequency = (Spinner) findViewById(R.id.spinnerFrquency);
        ...
        spinnerFrequencyUnity = (Spinner) findViewById(R.id.spinnerFrequencyUnity);
    ...
    private void saveMedicalAppointment(View view) {
